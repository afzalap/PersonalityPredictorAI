...
def is_extroverted(base_line_angle, top_margin, line_spacing, slant_angle, word_spacing, letter_size):
    ...
    if letter_size > 3 or slant_angle == 90 or word_spacing == "wide" or top_margin > 0.2 or line_spacing == "heavy":
        return 1
    else:
        return 0
...
def is_introverted(base_line_angle, top_margin, line_spacing, slant_angle, word_spacing, letter_size):
    ...
    if letter_size < 2.5 or slant_angle > 105 or top_margin < 0.1 or word_spacing == "closely spaced"  or line_spacing == "normal":
        return 1
    else:
        return 0
...
def has_emotional_stability(base_line_angle, top_margin, line_spacing, slant_angle, word_spacing, letter_size):
    ...
    if base_line_angle >= -5 or base_line_angle <= 5 or word_spacing == "evenly spaced":
        return 1
    else:
        return 0
...
def is_neurotic(base_line_angle, top_margin, line_spacing, slant_angle, word_spacing, letter_size):
    ...
    if base_line_angle >= -30 or base_line_angle <= -5 or slant_angle in [90, 75, 60, 45, 105, 120, 135]:
        return 1
    else:
        return 0
...
def is_open_to_experience(base_line_angle, top_margin, line_spacing, slant_angle, word_spacing, letter_size):
    ...
    if letter_size >= 2.5 or letter_size <= 3 or slant_angle in [60, 75] or word_spacing == "evenly spaced" or line_spacing in ["normal", "heavy"]:
        return 1
    else:
        return 0
...
def is_conscientious(base_line_angle, top_margin, line_spacing, slant_angle, word_spacing, letter_size):
    ...
    if letter_size >= 1.5 or letter_size <= 2.5 or top_margin < 0.1 or word_spacing == "evenly spaced" :
        return 1
    else:
        return 0
...
def is_agreeable(base_line_angle, top_margin, line_spacing, slant_angle, word_spacing, letter_size):
    ...
    if letter_size >= 2.5 or letter_size <= 3 or slant_angle in [60, 75] or word_spacing == "evenly spaced" or line_spacing == "normal":
        return 1
    else:
        return 0
